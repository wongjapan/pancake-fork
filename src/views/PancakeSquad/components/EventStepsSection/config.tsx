...
import { SaleStatusEnum, UserStatusEnum } from 'views/ArborSquad/types'
  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active ArborSwap Profile to buy Minting Tickets and mint a Arbor Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      bodyText: [
        ...
        `04:00 UTC, Oct. 7 ${t(
          'Pre-sale: Wallets which held “Gen 0” Arbor Bunnies NFTs (bunnyID 0,1,2,3,4) at a snapshot taken some time between 12 and 2 hours before the presale begins can purchase one Squad Ticket per Gen 0 NFT.',
        )}`,
        `08:00 UTC, Oct. 7 ${t(
          'Public Sale: Any wallet with an active Arbor Profile can purchase up to 10 Squad Tickets, while stocks last.',
        )}`,
      ],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Claim Phase'),
      bodyText: [
        t('During this phase, any wallet holding a Squad Ticket can redeem their ticket to claim a Arbor Squad NFT.'),
      ],
      buttons: (
        <>
          {hasData && (
