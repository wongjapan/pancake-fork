...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the Arbor Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 Arbor Bunny NFTs at the snapshot may also purchase one additional Arbor Squad NFT in the presale for each Arbor Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of CAKE spent on Arbor Squad NFTs will be burned as part of our weekly CAKE burn.')],
  },
  {
