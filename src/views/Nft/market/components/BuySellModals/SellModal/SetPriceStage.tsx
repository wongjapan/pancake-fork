...
import { Flex, Grid, Box, Text, Button, BinanceIcon, ErrorIcon, useTooltip, Skeleton } from '@arborswap/uikit'
    ...
    <>
      ...
      <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
        ...
        <Box>
          ...
          <Text small color="textSubtle">
            {t('Sales are in WBNB. You can swap WBNB to BNB 1:1 for free with ArborSwap.')}
          </Text>
        </Box>
      </Grid>
      <Divider />
