...
import { Link } from '@arborswap/uikit'
...
const config = [
  {
    ...
    description: [
      ...
      <Trans>
        In the Public Sale, everyone with an active ArborSwap profile can commit. However the maximum amount of CAKE
  ...
  },
  {
    ...
    description: [
      ...
      <Trans>Just remember you need an active ArborSwap Profile in order to participate.</Trans>,
    ],
  },
  {
