...
import { useTranslation, ContextApi } from '@arborswap/localization'
import { Box, Card, CardBody, CardHeader, Flex, HelpIcon, Text, useTooltip } from '@arborswap/uikit'
...
export const cardConfig = (
  ...
  switch (poolId) {
    case PoolIds.poolBasic:
      if (meta?.version >= 3.1) {
        const MSG_MAP = {
          needQualifiedNFT: t('Set ArborSquad NFT as Arbor Profile avatar.'),
          needQualifiedPoints: t('Reach a certain Arbor Profile Points threshold.'),
        }
