...
import { Flex, Text, Heading, NftIcon, BunnyPlaceholderIcon } from '@arborswap/uikit'
  ...
  return (
    <StyledFlex flexDirection="column" mb="32px">
      ...
      <Flex>
        ...
        <Text mt="8px">
          {t(
            '300 Mobox Avatars NFT + 300 ArborSwap newly designed NFT to the top 100 traders in each of the three teams.',
          )}
        </Text>
      </Flex>
      <Flex>
