import { ButtonsEnum } from 'views/ArborSquad/components/Header/types'
import { getCurrentButton } from 'views/ArborSquad/components/Header/utils'
import { SaleStatusEnum, UserStatusEnum } from 'views/ArborSquad/types'

describe('ArborSquad/Header/utils/getCurrentButton', () => {
