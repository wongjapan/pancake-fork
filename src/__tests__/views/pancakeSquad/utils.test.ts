...
import { getAltText, getEventStepStatus, getEventText } from 'views/ArborSquad/utils'

const HOUR_IN_MS = 3600 * 1000

describe('ArborSquad/utils/getEventStepStatus', () => {
...
describe('ArborSquad/utils/getEventText', () => {
  it('Should return past status', () => {
    // Given
    const eventStatus = [SaleStatusEnum.Presale, SaleStatusEnum.Sale]
    const saleStatus = SaleStatusEnum.Claim
...
describe('ArborSquad/utils/getAltText', () => {
