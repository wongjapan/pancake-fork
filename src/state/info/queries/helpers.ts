...
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, ArborDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | ArborDayData): ChartEntry => ({
