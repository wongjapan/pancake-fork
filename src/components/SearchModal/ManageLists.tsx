...
import { Button, CheckmarkIcon, CogIcon, Input, LinkExternal, Text, Toggle, useTooltip } from '@arborswap/uikit'
...
import { useFetchListCallback } from '@arborswap/token-lists'
import uriToHttp from '@arborswap/utils/uriToHttp'
  ...
  const sortedLists = useMemo(() => {
    ...
    return listUrls
      ...
      .sort((u1, u2) => {
        ...
        if (l1 && l2) {
          // Always make ArborSwap list in top.
