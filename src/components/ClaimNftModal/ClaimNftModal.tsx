import { Flex, Text, Button, Modal, InjectedModalProps, useToast } from '@arborswap/uikit'
    ...
    <Modal title={t('Congratulations!')} onDismiss={onDismiss}>
      <Flex flexDirection="column" alignItems="center" justifyContent="center" maxWidth="320px">
        ...
        <Text bold color="secondary" textAlign="center" fontSize="18px" mb="24px">
          {t(
            'Celebrate Christmas and New Year with us! Enjoy this wonderful NFT crafted by Chef Cecy and the winner from our #ArborChristmas event.',
          )}
        </Text>
